...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = os.environ["USER_NAME"]         # 用户名
UUID = os.environ["UUID"]                     # UUID，留空则自动生成
PORT = os.environ["PORT"]                   # Vmess端口，留空或0则自动生成
DOMAIN = os.environ["DOMAIN"]                   # 域名，留空则自动获取
CF_TOKEN = os.environ["CF_TOKEN"]                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
